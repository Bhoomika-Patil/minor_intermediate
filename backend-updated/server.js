...
app.post('/minordb', (req, res) => {
  ...
  connection.query(sql, values, (error, results) => {
    ...
    // Send the userid_stored to the other Node.js file
    axios.post('http://localhost:5002/receive-userid', { userid: userid_stored })
      .then(response => {
        console.log('Userid sent to receiver:', response.data);
      })
      .catch(error => {
        console.error('Error sending userid to receiver:', error);
      });
